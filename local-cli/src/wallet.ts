/**
 * Wallet bootstrap aligned with
 * [bricktowers/midnight-local-network](https://github.com/bricktowers/midnight-local-network) `src/utils.ts`
 * (undeployed, ledger-v8, WalletFacade.init).
 */
